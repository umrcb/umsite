                    ...
                    <div className="max-w-4xl mx-auto space-y-10">
                        ...
                        <div className="prose dark:prose-invert max-w-none text-center md:text-right space-y-6" dir="rtl">
                            ...
                            <p className="text-lg text-foreground/80 leading-relaxed font-amiri">
                                هل تبحث عن <strong>أفضل شركة نقل معتمرين</strong>؟ نحن في Umrah Cabs نقدم لكم خدمات <strong>توصيل من مطار جدة الى مكة</strong> بأعلى معايير الراحة والأمان. ندرك أن رحلة العمرة تبدأ من لحظة الوصول، لذا نوفر لكم استقبالاً خاصاً في المطار مع خدمة حمل الحقائب والترحيب.
                            </p>
                            <p className="text-lg text-foreground/80 leading-relaxed font-amiri">
