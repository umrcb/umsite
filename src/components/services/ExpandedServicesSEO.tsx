                ...
                <div className="mb-20">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 items-start">
                        <div className="text-slate-700 dark:text-slate-300 space-y-5 leading-relaxed">
                            ...
                            <p>
                                While high-speed trains exist, thousands of pilgrims prefer our <Link href="/services/makkah-madinah-taxi" className="text-primary font-bold hover:underline">Makkah to Madinah taxi</Link> service for its unmatched convenience. We pick you up directly from your hotel lobby in Makkah—handling all your heavy luggage—and drop you directly at your accommodation in Madinah.
                            </p>
                            <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 mt-6">
                                ...
                                <ul className="space-y-3 text-sm">
                                    <li className="flex gap-2">
                                        ...
                                        <span><strong>Zero Luggage Restrictions:</strong> Unlike trains, our SUVs (GMC Yukon) can carry unlimited Zamzam water boxes and massive suitcases.</span>
                                    </li>
                                    <li className="flex gap-2">
                                        <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2 shrink-0" />
                                    ...
                                    <li className="flex gap-2">
                                        <div className="w-1.5 h-1.5 rounded-full bg-primary mt-2 shrink-0" />
                                        <span><strong>Group Economics:</strong> For families of 5 or more, booking a Hyundai Staria van is significantly cheaper than buying individual train tickets.</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div className="bg-navy-900 rounded-3xl p-8 text-white shadow-2xl relative overflow-hidden">
                            ...
                            <h4 className="text-2xl font-bold font-playfair mb-4 flex items-center gap-3">
                                <MapPin className="text-primary" /> Exclusive Ziyarat Tours
                            </h4>
                            <p className="text-slate-300 mb-6 leading-relaxed">
                                No Umrah is complete without visiting the historical Islamic sites. We offer dedicated 3 to 4-hour <Link href="/services/ziyarat-tours" className="text-white underline decoration-gold underline-offset-4 font-semibold hover:text-primary transition-colors">Ziyarat packages</Link> in both holy cities.
                            </p>
                            <div className="space-y-4">
                                <div className="bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
                                    <strong className="block text-primary mb-1">Makkah Ziyarat Includes:</strong>
                                ...
                                <div className="bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-colors">
                                    <strong className="block text-primary mb-1">Madinah Ziyarat Includes:</strong>
                ...
                <div className="mb-16">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-700 p-8 md:p-12">
                        <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-8">
                            Most pilgrims land at King Abdulaziz International Airport (JED) before proceeding to Makkah. Booking your <Link href="/services/jeddah-airport-transfer" className="text-primary font-bold hover:underline">Jeddah Airport taxi</Link> in advance eliminates the stress of haggling with local drivers after a long flight. Our operations team monitors your flight arrival via radar, meaning if your flight is delayed by 2 hours, your driver will automatically adjust his arrival time—no extra charge.
                        </p>
